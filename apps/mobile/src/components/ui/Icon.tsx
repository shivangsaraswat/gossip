...
export interface IconProps extends SvgProps {
    name: 'search' | 'add' | 'notifications' | 'checkmark' | 'menu' | 'chat' | 'people' | 'call' | 'settings' | 'chevron-right' | 'close' | 'chevron-back' | 'globe' | 'arrow-back' | 'checkmark-circle' | 'ellipsis-vertical' | 'phone-portrait-outline' | 'call-outline' | 'videocam-outline' | 'chevron-forward' | 'image-outline' | 'notifications-outline' | 'timer-outline' | 'ban-outline' | 'flag-outline';
    size?: number;
    color?: string;
}
